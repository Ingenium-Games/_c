...
RegisterCommand('car', function(source, args, rawCommand)
    ...
    local heading = GetEntityHeading(src)
    TriggerClientEvent("Client:Notify", src, coords.x..","..coords.y..",".. coords.z..","..heading)
    local retval, id = c.CreateVehicle(args[1], coords.x, coords.y, coords.z, heading)
